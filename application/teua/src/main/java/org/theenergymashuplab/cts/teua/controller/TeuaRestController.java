...
package org.theenergymashuplab.cts.teua.controller;
...
import org.theenergymashuplab.cts.teua.EiResponse;
import org.theenergymashuplab.cts.teua.EiTender;
import org.theenergymashuplab.cts.teua.EiTransaction;
import org.theenergymashuplab.cts.teua.controller.payloads.ClientCreateTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.ClientCreateTransactionPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.ClientCreatedTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.ClientCreatedTransactionPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EICanceledTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EiCancelTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EiCreateTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EiCreateTransactionPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EiCreatedTenderPayload;
import org.theenergymashuplab.cts.teua.controller.payloads.EiCreatedTransactionPayload;
...
//			mapReturns = LmaRestController.postLmaToTeuaPartyIdMap.put(actorNumericIds[i], teuaUri);
			mapReturns = postLmaToTeuaPartyIdMap.put(actorNumericIds[i], teuaUri);
			
			logger.trace("mapReturns '"+ mapReturns + "' for key " + actorNumericIds[i]);
			logger.trace("Map size " + postLmaToTeuaPartyIdMap.size() +
	 ...
	 */
	@GetMapping("/postLmaToTeuaPartyIdMap")
	public ConcurrentHashMap<Long, String> getPostLmaToTeuaPartyIdMap() {
		return TeuaRestController.postLmaToTeuaPartyIdMap;
	}
