...
package org.theenergymashuplab.cts.lma.controller;
...
import org.theenergymashuplab.cts.lma.controller.payloads.EICanceledTenderPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.EiCancelTenderPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.EiCreateTenderPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.EiCreateTransactionPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.EiCreatedTenderPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.EiCreatedTransactionPayload;
import org.theenergymashuplab.cts.lma.controller.payloads.PositionAddPayload;
import org.theenergymashuplab.cts.lma.TenderIdType;
import org.theenergymashuplab.cts.lma.SideType;
import org.theenergymashuplab.cts.lma.Interval;
import org.theenergymashuplab.cts.lma.EiTransaction;
import org.theenergymashuplab.cts.lma.EiTender;
...
//				tempCreate.toString());
		...
		//Fetching PostLmaToTeuaPartyIdMap from Teua
		ResponseEntity<ConcurrentHashMap> response = restTemplate.getForEntity("http://localhost:8080/teua/postLmaToTeuaPartyIdMap", ConcurrentHashMap.class);
		//Adding fetched PostLmaToTeuaPartyIdMap to local PostLmaToTeuaPartyIdMap
		setPostLmaToTeuaPartyIdMap(response.getBody());
